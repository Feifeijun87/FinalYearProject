                ...
                <ContentTemplate>
                    <div class="ForgetPanel" id="MainPanel" runat="server">
                        ...
                        <div class="description">
                            <asp:Label ID="lblDesc" runat="server" ForeColor="Black">Enter your student ID to retrieve your password</asp:Label>
                        </div>
                        ...
                        <div runat="server" id="EmailPanel">
                            <div class="EmailDetails">
                                ...
                                <asp:TextBox ID="txtStudentID" CssClass="txtEmail" runat="server" placeholder="Student ID"></asp:TextBox>
