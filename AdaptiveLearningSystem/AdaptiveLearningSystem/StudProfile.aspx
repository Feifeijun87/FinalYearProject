<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudProfile.aspx.cs" Inherits="AdaptiveLearningSystem.StudProfile" %>
...
<body >
    ...
    <div class="wrap-content" >
           ...
           <table class="profileTable" style="width:600px; margin-left:20px;"  >
                        <tr >
                            ...
                            <td class="auto-style3">
                                <asp:Label ID="lblStudName" runat="server" Text="Ms. Loo Zhe Xin" ></asp:Label>
                            </td>
                         ...
                         <tr>
                            <td class="stayRight" style="text-align:right; padding:10pt;">&nbsp;
                                <asp:Label ID="Label1" runat="server" Text="Programme : " ></asp:Label>
                            </td>
                            <td class="auto-style23">
                                <asp:Label ID="lblProgramme" runat="server" Text="Bachelor in Software System Development" ></asp:Label>
                            </td>
                        ...
                        <tr>
                            <td class="stayRight" style="text-align:right; padding:10pt;">&nbsp;
                                <asp:Label ID="Label9" runat="server" Text="Tutorial group :" ></asp:Label>
                            </td>
                            <td class="auto-style23" >
                                <asp:Label ID="lblTutGrp" runat="server" Text="Block A 202" ></asp:Label>
                            </td>
        ...
        <div class="BottomButtonGroup">
            ...
            <asp:Button CssClass="BottomButton" ID="ChgPhoneBtn" runat="server" Text="Change Phone No."  />
            <asp:Button CssClass="BottomButton" ID="ChgPwdBtn" runat="server" Text="Change Password"  />
        </div>
    </div>
