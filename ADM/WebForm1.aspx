<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="ADM.WebForm1" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="wrap-content">
                    ...
                    <table style="margin-left: 20px; border-bottom-style: none;" class="auto-style1">
                        <tr>
                            <td colspan="2" class="auto-style5">
                                ...
                                <asp:DropDownList ID="ddlCourse" runat="server" Width="241px" Height="33px" DataSourceID="SqlDataSource1" DataTextField="Courses" DataValueField="Courses" OnSelectedIndexChanged="DropDownList3_SelectedIndexChanged">
                                </asp:DropDownList>
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:fyp %>" ProviderName="<%$ ConnectionStrings:fyp.ProviderName %>" SelectCommand="SELECT CourseID + ' ' + CourseName AS Courses FROM Course"></asp:SqlDataSource>
                        ...
                        <tr>
                            <td colspan="2">
                                <label id="tutStart" style="font-family: Arial, Helvetica, sans-serif; font-size: large">
                                <br />
                                Duration (days):&nbsp; <asp:TextBox ID="txtDuration" runat="server" Width="101px" OnTextChanged="txtTutNum_TextChanged"></asp:TextBox>
                                <br />
                                <label id="tutnum0" style="font-family: Arial, Helvetica, sans-serif; font-size: large">
                                    <asp:Label ID="lblDurationEnter" runat="server" ForeColor="Red"></asp:Label>
                                </label>
                                </label>
                            </td>
                ...
                <table class="editProf">
                   ...
                   <tr>
                        ...
                        <td class="auto-style6">
                            <asp:TextBox ID="txtMed" runat="server" Width="62px"></asp:TextBox>/ <asp:Label ID="lblCompMedNum" runat="server">0</asp:Label>
                            
                        </td>
                    </tr>
                    <tr>
                        <td class="stayRight">
                            Compulsory Difficult:</td>
                        <td class="auto-style6">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblCompErrorMsg" runat="server" Visible="False"></asp:Label>
                        </td>
                    </tr>
                </table>
            ...
            <div class="BottomButtonGroup">
                ...
                <asp:Button ID="btnCancel" CssClass="BottomButton" runat="server" Text="Close" OnClick="btnContactCancel_Click" />
 </div>
                </ContentTemplate>
                    </asp:UpdatePanel>
