<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentRegister.aspx.cs" Inherits="ADM.StudentRegister" %>
            ...
            <asp:Label CssClass="label" ID="Label9" runat="server" Text="Student Email: "></asp:Label><asp:TextBox ID="txtEmail" runat="server"></asp:TextBox>
                ...
                <tr>
                    <td><asp:Label CssClass="label" ID="Label11" runat="server" Text="Tutorial Group:"></asp:Label><asp:DropDownList ID="ddlGroup" runat="server">
                        <asp:ListItem Value=""></asp:ListItem><asp:ListItem Value="G1">Group 1</asp:ListItem> <asp:ListItem Value="G2">Group 2</asp:ListItem> <asp:ListItem Value="G3">Group 3</asp:ListItem> <asp:ListItem Value="G4">Group 4</asp:ListItem> <asp:ListItem Value="G5">Group 5</asp:ListItem> <asp:ListItem Value="G6">Group 6</asp:ListItem>
