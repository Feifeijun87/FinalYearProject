...
namespace ADM
{
    public partial class StudentRegister : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (Session["imgupload"] == null && Request.Files["imgupload"].ContentLength > 0)
                {
                    Session["imgupload"] = Request.Files["imgupload"];
                    lblImgUpload.Text = Path.GetFileName(Request.Files["imgupload"].FileName);
                }

                else if (Session["imgupload"] != null && (Request.Files["imgupload"].ContentLength == 0))
                {
                ...
                else if (Request.Files["imgupload"].ContentLength > 0)
                {
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            hideErrorTage();
            if (Request.Files["imgupload"].ContentLength > 0)
            {
