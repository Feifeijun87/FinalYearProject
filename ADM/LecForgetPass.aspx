<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LecForgetPass.aspx.cs" Inherits="ADM.LecForgetPass" %>
                ...
                <ContentTemplate>
                    <div class="ForgetPanel" id="MainPanel" runat="server">
                        ...
                        <div class="description">
                            <asp:Label ID="lblDesc" runat="server" ForeColor="Black">Enter your email address to retrieve your pass</asp:Label>
                        </div>
