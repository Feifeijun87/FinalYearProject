...
namespace ADM
{
    public partial class WebForm3 : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            { 
                ...
                if (easyLeft == 0 && medLeft == 0 && hardLeft == 0)
                {
                    ...
                    cmdAddTut.Parameters.AddWithValue("@p3", "17WMR09512"); //stud ID
        ...
        protected void insertDB(double matchRate)
        {
            ...
            cmdInsert.Parameters.AddWithValue("@MatchPercent", matchRate);
            ...
            cmdInsert.Parameters.AddWithValue("@QuestionSeqNo", currCount + 1);
        ...
        {
            int point=0;
            double timePercent = (Double.Parse(secUsed.ToString()) / Double.Parse(listTime[currCount].ToString())) * 100;
            if (timePercent < 25)
                point = 3;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                //get quest
                string sql = "SELECT QuestionID, Question, Level, TimeLimit FROM [Question] WHERE TutorialID = @TutorialID AND Status = 1";
                SqlCommand cmdGetQuest = new SqlCommand(sql, conn);
                cmdGetQuest.Parameters.AddWithValue("@TutorialID", tutorialID);
                ...
                conn.Open();
                //get comp level
                sql = "SELECT [CompulsaryEasy], [CompulsaryMedium], [CompulsaryHard] FROM [Tutorial] WHERE TutorialID = @TutorialID";
                SqlCommand cmdGetComp = new SqlCommand(sql, conn);
                cmdGetComp.Parameters.AddWithValue("@TutorialID", tutorialID);
                ...
                for (int j = 0; j < listQuestID.Count; j++)
                {
                    ...
                    cmdQuesDoneCount.Parameters.AddWithValue("@StudentID", "17WMR09512");
        ...
        protected void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            lblTimeCount.Text = mm.ToString() + ":" + ss.ToString();
        }
    }
}